...
import { ChevronLeft, ChevronRight, Facebook, Instagram, Menu, ShoppingBag, Twitter } from "lucide-react";
    ...
    return (
        <main className="min-h-screen bg-white overflow-hidden">
          ...
          <nav className="text-xl sm:text-2xl md:text-3xl space-y-4 sm:space-y-6">
            ...
            <button className="block hover:underline text-left w-full">Artists</button>
            <button className="block hover:underline text-left w-full">Visit</button>
            <button className="block hover:underline text-left w-full">About</button>
            <button onClick={openShop} className="block hover:underline text-left w-full">
              Shop
            </button>
            <button className="block hover:underline text-left w-full">Contact</button>
          </nav>
        </div>
      )}
